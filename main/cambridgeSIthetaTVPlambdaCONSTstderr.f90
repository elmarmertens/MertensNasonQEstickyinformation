PROGRAM main
  ...
  CHARACTER (LEN=200) :: modellabel ='SIthetaTVPlambdaCONSTSTDERR'
  INTEGER  :: Ngrid = 500
  ...
  !$OMP PARALLEL DO SHARED(doSecondResamplingStep,doInflationNoise,logMDD,ESS,gridCount,gridtimer,Nparticles,T,Ngrid,y,yNaN,Ex0,sqrtVx0,A0,A0V,SigAT,SigAdof,LAMBDAALPHA,LAMBDABETA,LAMBDAN,Eh0,Vh0,hvarT,hvarDof,sigmaT,sigmaDof) PRIVATE(TID,VSLstream,seed,errcode)  DEFAULT(NONE) SCHEDULE(DYNAMIC)
  ...
  DO i=1,Ngrid
     ...
     CALL particleLLF(doSecondResamplingStep, doInflationNoise,T, logMDD(:,i), ESS(:,i), Ny, y, yNaN, Nparticles, Nx, NsigmaX, Nw, Ex0, sqrtVx0, p, a0, a0V, sigaT, sigaDof, lambdaAlpha, lambdaBeta, lambdaN, Nsv, Eh0, Vh0, hvarT, hvarDof, sigmaT, sigmaDof, VSLstream)
...
SUBROUTINE particleLLF(doSecondResamplingStep, doInflationNoise, T, logMDD, ESS, Ny, y, yNaN, Nparticles, Nx, NsigmaX, Nw, Ex0, sqrtVx00, p, a0, a0V,  sigaT, sigaDof, lambdaAlpha0, lambdaBeta0, lambdaN0, Nsv, Eh0, Vh0, hvarT, hvarDof, sigmaT, sigmaDof, VSLstream)
...
FUNCTION drawtruncnorm(N, x0, sig, lb, ub, VSLstream) RESULT(x)
  ...
  DOUBLE PRECISION, DIMENSION(N) :: x0, sig, x, dx
