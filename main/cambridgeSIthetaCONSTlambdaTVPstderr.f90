PROGRAM main
  ...
  CHARACTER (LEN=200) :: modellabel ='SIthetaCONSTlambdaTVPSTDERR'
  INTEGER  :: Ngrid = 500
  ...
  !$OMP PARALLEL DO SHARED(doSecondResamplingStep,doInflationNoise,logMDD,ESS,gridCount,gridtimer,Nparticles,T,Ngrid,y,yNaN,Ex0,sqrtVx0,A0,AV0,LAMBDA0,LAMBDA0V,siglambdaT,siglambdaDof,Eh0,Vh0,hvarT,hvarDof,sigmaT,sigmaDof) PRIVATE(TID,VSLstream,seed,errcode)  DEFAULT(NONE) SCHEDULE(DYNAMIC)
  ...
  DO i=1,Ngrid
     ...
     CALL particleLLF(doSecondResamplingStep, doInflationNoise,T, logMDD(:,i), ESS(:,i), Ny, y, yNaN, Nparticles, Nxx, NsigmaXX, Nx, Nw, Ex0, sqrtVx0, p, a0, aV0, lambda0, lambda0V, siglambdaT, siglambdaDof, Nsv, Eh0, Vh0, hvarT, hvarDof, sigmaT, sigmaDof, VSLstream)
...
SUBROUTINE particleLLF(doSecondResamplingStep, doInflationNoise, T, logMDD, ESS, Ny, y, yNaN, Nparticles, Nxx, NsigmaXX, Nx, Nw, Ex0, sqrtVx00, p, a0, aV0, lambda0, lambda0V, siglambdaT, siglambdaDof, Nsv, Eh0, Vh0, hvarT, hvarDof, sigmaT, sigmaDof, VSLstream)
