PROGRAM main
  ...
  CALL plefilter(doSecondResamplingStep, dofAPFfattail, doInflationNoise, T, Ny, y, yNaN, Nparticles, PARTICLEweights, logMDD, DRAWpihat, DRAWpifcst, DRAWpipersistence, DRAWxhat, DRAWsqrtSigmaX, DRAWxsig, DRAWxgain, Nx, NsigmaX, Nw, Ex0, sqrtVx0, DRAWgapnoisehat, p, DRAWa, a0, a0V, DRAWsiga, sigaT, sigaDof, DRAWlambda, lambda0, lambda0V, DRAWsiglambda, siglambdaT, siglambdaDof, DRAWsvol, Nsv, Eh0, Vh0, DRAWhInno, hvarT, hvarDof, DRAWsigma, sigmaT, sigmaDof, VSLstream,timer)
  ...
  IF (doSmoother) THEN
     ...
     CALL plesmoother(doInflationNoise, Nsmoother, smootherNparticles, T, p, SMOOTHERa, SMOOTHERlambda, Nsv, SMOOTHERsvol, SMOOTHERhinno, SMOOTHERsigma, Nparticles, PARAMweights, PARAMsiga, PARAMsiglambda, PARAMhInno, PARAMsigma, a0, a0V, lambda0, lambda0V, Eh0, Vh0, Ex0, sqrtVx0, Ny, y, yNaN, Nx, NsigmaX, Nw, VSLstream)
...
SUBROUTINE plefilter(doSecondResamplingStep, dofAPFfattail, doInflationNoise, T, Ny, y, yNaN, Nparticles, PARTICLEweights, logMDD, DRAWpihat, DRAWpifcst, DRAWpipersistence, DRAWxhat, DRAWsqrtSigmaX, DRAWxsig, DRAWxgain, Nx, NsigmaX, Nw, Ex0, sqrtVx00, DRAWgapnoisehat, p, DRAWa, a0, a0V, DRAWsiga, sigaT, sigaDof, DRAWlambda, lambda0, lambda0V, DRAWsiglambda, siglambdaT, siglambdaDof, DRAWsvol, Nsv, Eh0, Vh0, DRAWhInno, hvarT, hvarDof, DRAWsigma, sigmaT, sigmaDof, VSLstream, timer)
  ...
  INTENT(INOUT) :: PARTICLEweights, logMDD, DRAWa, DRAWlambda, DRAWxhat, DRAWsqrtSigmaX, DRAWxsig, DRAWxgain, DRAWsvol, DRAWsiga, DRAWsiglambda, DRAWhInno, DRAWsigma, VSLstream, timer
...
SUBROUTINE plesmoother(doInflationNoise, Nsmoother, Nparticles, T, p, SMOOTHERa, SMOOTHERlambda, Nsv, SMOOTHERh, SMOOTHERhinno, SMOOTHERsigma, Nparamparticles, PARAMweights, PARAMsiga, PARAMsiglambda, PARAMhInno, PARAMsigma, a0, a0V, lambda0, lambda0V, Eh0, Vh0, Ex0, sqrtVx0, Ny, y, yNaN, Nx, NsigmaX, Nw, VSLstream)
  ...
  !$OMP& SHARED(SMOOTHERsiga, SMOOTHERsiglambda,SMOOTHERhinno,SMOOTHERsigma), &
  !$OMP& SHARED(SMOOTHERa, SMOOTHERlambda,SMOOTHERh), &
  !$OMP& PRIVATE(VSLlocal,TID), & 
  !$OMP& PRIVATE(j, i, errcode), & 
  !$OMP& FIRSTPRIVATE(C), &
  !$OMP& PRIVATE(invR, invSqrtR, ytilde, Bsv, w, cdf, hshock, z, lambdashock, lambdaCDFlb, lambdaCDFub, ashock, aCDFlb, aCDFub, SVpdf, Apdf, LAMBDApdf, eta, sqrtSigmaX, logdetsqrtLAMBDA, sqrtLAMBDA, sqrtOmegaHAt, lambdaHat, lambda, zhat, prevSV, prevH, prevLAMBDA, prevA, A, qr1R, qr2R, qr3R), &
  !$OMP& PRIVATE(logMDD, PARTICLEweights, FILTERxhat, FILTERsqrtSigmaX, FILTERlambda, FILTERa, FILTERh), &
  !$OMP& SHARED(a0, a0V, lambda0, lambda0V, Eh0, Vh0, Ex0, sqrtVx0)
  ...
  DO k=1,Nsmoother
     ...
     call particlefilter(doSecondResamplingStep, dofAPFfattail, T, Ny, y, yNaN, Nparticles, PARTICLEweights, logMDD, FILTERxhat, FILTERsqrtSigmaX, Nx, NsigmaX, Nw, Ex0, sqrtVx0, p, FILTERa, a0, a0V, SMOOTHERsiga(k), FILTERlambda, lambda0, lambda0V, SMOOTHERsiglambda(k), FILTERh, Nsv, Eh0, Vh0, SMOOTHERhInno(:,k), SMOOTHERsigma(:,k), VSLlocal)
